...
// InspectTemplateResources inspects the compiled Radius Bicep template's resources in a single pass
// to determine if an environment resource is present and to find any deprecated resource types.
//
